...
<template>
  <div class="page-container">
    ...
    <div class="page-header">
      ...
      <span class="page-title">学员管理</span>
    </div>
    ...
    <div class="table-card">
      <el-table :data="tableData" border style="width: 100%" fit @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="clazzName" label="班级" align="center" min-width="140" />
        ...
        <el-table-column prop="degree" label="最高学历" align="center" width="90">
          <template #default="scope">
        ...
        <el-table-column prop="violationCount" label="违纪次数" align="center" width="85" />
        <el-table-column prop="violationScore" label="违纪扣分" align="center" width="85" />
        <el-table-column prop="updateTime" label="最后修改时间" align="center" width="160" />
        <el-table-column label="操作" align="center" width="220" fixed="right">
          <template #default="scope">
            <el-button type="primary" link @click="updateStu(scope.row.id); resetForm(stuFormRef)">
              <el-icon><Edit /></el-icon> 编辑
            </el-button>
            <el-button type="warning" link @click="openViolation(scope.row.id)">
              <el-icon><Warning /></el-icon> 违纪
            </el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :title="formTitle" width="600px" destroy-on-close>
      <el-form :model="stu" ref="stuFormRef" :rules="rules" label-width="80px">
        <el-row :gutter="16">
          <el-col :span="12">
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button @click="dialogFormVisible = false; resetForm(stuFormRef)">取 消</el-button>
          <el-button type="primary" @click="save(stuFormRef)">保 存</el-button>
        </div>
      </template>
    </el-dialog>
  </div>
